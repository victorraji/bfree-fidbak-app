...
<div class="body-content">
      <div class="reset-form">
        ...
        <form>
         ...
         <button  class="input" @click="showModal=true">Reset Password</button>
         ...
         <p>Enter the new password that was just sent to {{word}}</p>
          <form>
          <div class="inputBox1">
          <label for="email">
          <input type="email" placeholder="Email Address"  required/>
         ...
         <router-link style="text-decoration: none; color: #fff;" to="/HomeRView"><button class="input1" @click="showModal=false"> Log In</button></router-link>
        </form>

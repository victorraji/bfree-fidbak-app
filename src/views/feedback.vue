...
width: 1440px;
height: 1024px;
background: -o-linear-gradient(odeg, #FFFF, #FFFF), rgba(0, 164, 219, 0.32);
}
...
padding: 40px 0px 40px 25px;
background: #00A4DB;
/*had to readjust some CSS on the figma to get this since the original CSS was outflowing*/
flex: none;
flex-grow: 0;
order: 1;
position: static;
